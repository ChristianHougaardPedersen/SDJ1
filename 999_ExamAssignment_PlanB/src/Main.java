...
public class Main
{
  public static void main(String[] args)
  {
    ...
    ArrayList<Resource> sdj1Res = new ArrayList<>();
    sdj1Res.add(r1);
    sdj1Res.add(r2);
    sdj1Res.add(r3);
    sdj1Res.add(r4);
    ...
    System.out.println("|Should be resources r1-r5| - " + lesson1.getResources());
    ...
    c1.addLesson(
        new Lesson("SDJ Lesson 2", new Date(7, 1, 2022), new Time(13, 20, 0),
            new Time(14, 20, 0), new ArrayList<>()));
...
/*
    ...
    c1.removeLesson(new Lesson("SDJ Lesson 2", new Date(7,1,2022), new Time(13,20,0), new Time(14,20,0), new ArrayList<Resource>()));
    ...
    //System.out.println("|Should print empty ArrayList| - " + s1.getAllCourses()); // throws exception - since student is not assigned to any courses
    s1.addCourse(c1);
    s1.addCourse(c2);
    s1.addCourse(c3);
    s1.addCourse(c4);
    System.out.println("|Should print all courses| - " + s1.getAllCourses());
    ...
    System.out.println(s1.getAllGrades());
